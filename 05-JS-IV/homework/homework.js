...
function pasarUsuarioAPremium (usuarios) {
  ...
  // Tu código:
  // USUARIOS [usurio1, usuario2, usuarioN]
  // cambiar todas las popiedades es premium de cada [usuario] del array USUARIOS
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  producto.calcularPrecioDescuento = function () {
    var dcto = (producto.precio * producto.porcentajeDeDescuento)
    var Pdcto = (producto.precio - dcto)
    return Pdcto;
  }
  return producto;
}
